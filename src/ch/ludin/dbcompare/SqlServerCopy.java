...
import ch.ludin.dbcompare.actions.AddAction;
import ch.ludin.dbcompare.actions.CompareAction;
import ch.ludin.dbcompare.actions.CompareEditorAction;
import ch.ludin.dbcompare.actions.DeleteAction;
import ch.ludin.dbcompare.actions.DuplicateAction;
import ch.ludin.dbcompare.actions.ListAction;
import ch.ludin.dbcompare.actions.SearchDbConfigsAction;
import ch.ludin.dbcompare.handler.DeploymentDescriptorDialog;
import ch.ludin.dbcompare.handler.DeploymentDescriptorHandler;
import ch.ludin.dbcompare.model.ConnectionItem;
import ch.ludin.dbcompare.model.CustomSQLException;
import ch.ludin.dbcompare.model.DatabaseStructureReader;
import ch.ludin.dbcompare.model.DatabaseStructureReaderFactory;
import ch.ludin.dbcompare.model.ModelProvider;
import ch.ludin.dbcompare.model.StringInput;
import ch.ludin.dbcompare.model.StringStorage;
import ch.ludin.dbcompare.view.ConnectionViewerComparator;
import ch.ludin.dbcompare.view.DrawLabelProvider;
import ch.ludin.dbcompare.view.ErrorLabelProvider;
import ch.ludin.dbcompare.view.LabelEditingSupport;
import ch.ludin.dbcompare.view.LabelLabelProvider;
import ch.ludin.dbcompare.view.PasswordEditingSupport;
import ch.ludin.dbcompare.view.PasswordLabelProvider;
import ch.ludin.dbcompare.view.StatusLabelProvider;
import ch.ludin.dbcompare.view.UrlEditingSupport;
import ch.ludin.dbcompare.view.UrlLabelProvider;
import ch.ludin.dbcompare.view.UsernameEditingSupport;
import ch.ludin.dbcompare.view.UsernameLabelProvider;
